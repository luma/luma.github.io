...
function wp_synhighlight_get_tpl_header($instanceNumber, $title, $bookmarkname, $initiallyHidden) {
	...
	$output .= get_button_html($bookmarkname, $instanceNumber, 'code.png', 'wpsh_code', 
			__("Show code only", 'wp-synhighlighter'));
	$output .= get_button_html($bookmarkname, $instanceNumber, 'printer.png', 'wpsh_print', 
			__("Print code", 'wp-synhighlighter'));
	$output .= get_button_html($bookmarkname, $instanceNumber, 'info.gif', 'wpsh_about', 
 ...
 */
function get_button_html($bookmarkname, $instanceNumber, $imageName, $jsFunctionName, $buttonHint) {
