...
<ul>
	...
	<ul class="tile has4col">
		<li><figure><a href="./gallery-single/"><img src="<?php bloginfo('template_url')?>/img/gallery_dummy.png" width="136" height="90" alt="dummy" /></a></figure></li>
